...
flag：是否标注词性  1--标注   0--不标注
'''
def NLPIR_FileProcess(source_path,output_path,flag):
    FileProcess(c_char_p(source_path.encode('UTF8')),c_char_p(output_path.encode('UTF8')),c_int(flag))
...
#     i=c_int(1)
#     print(FileProcess(p1,p2,i))
    
#     p = "今天天气不错。"
#     p = p.encode('UTF8')
#     print(p)
#     result = ParagraphProcess(p, c_int(1))
