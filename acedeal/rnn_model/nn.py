...
ace_data_train_labels_file = open('../ace_data_process/ace_data/ace_data_train_labels.pkl', 'rb')
...
ace_data_test_labels_file = open('../ace_data_process/ace_data/ace_data_test_labels.pkl', 'rb')
...
# 权重
W = tf.Variable(tf.random_normal([200, 34]))
# 偏置量
b = tf.Variable(tf.random_normal([34]))
...
for i in range(100000):
    ...
    if i%1000==0:
        print("Setp: ",i, "Accuracy: ", sess.run(accuracy, feed_dict={x: ace_data_test, y_: ace_data_test_labels}))
